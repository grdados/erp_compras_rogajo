...
# Resumo table: fixed layout and width distribution (first occurrence only)
...
# Fornecedor details: smaller font + fixed widths (first occurrence)
t = t.replace(
