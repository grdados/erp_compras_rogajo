...
LICENCA_PERCENTUAL_SALARIO_MINIMO_MENSAL = os.getenv('LICENCA_PERCENTUAL_SALARIO_MINIMO_MENSAL', '0.338')
LICENCA_VALOR_MENSAL_PLANO = os.getenv('LICENCA_VALOR_MENSAL_PLANO', '548.00')
...
STRIPE_PRICE_ID_MENSAL = os.getenv('STRIPE_PRICE_ID_MENSAL', '')
